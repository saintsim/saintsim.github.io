...
require("core-js/features/fetch");
var WeatherData = /** @class */ (function () {
    function WeatherData(apiData) {
        this.apiData = apiData;
    }
    WeatherData.prototype.getTemperature = function () {
        var response = JSON.parse(this.apiData);
        return "Temperature: ".concat(response.hourly.temperature_2m[0], "\u00B0C");
    };
    return WeatherData;
}());
function getWeatherData() {
    return __awaiter(this, void 0, void 0, function () {
        var latitude, longitude, url, response, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    data = _a.sent();
                    return [2 /*return*/, new WeatherData(data)];
                case 4:
                    error_1 = _a.sent();
                    throw new Error("Failed to parse the weather data: " + error_1);
